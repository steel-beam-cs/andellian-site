...
export function AnalyticsOptOutControl() {
  ...
  return (
    <div className="mt-8 border border-[rgba(199,154,71,0.24)] bg-[#1b1e24] p-6 md:p-8">
      <p
        aria-live="polite"
        className="m-0 text-xl font-semibold text-[#f2ebdd]"
      >
        {statusMessage}
      </p>
      <p className="mt-3 max-w-2xl leading-7 text-[#a6a7a3]">
